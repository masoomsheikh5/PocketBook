...
class ExpenseView extends GetWidget<ExpenseController> {
  ...
  //   int id = await dbHelper.insertExpense(row);
              ...
              Container(
                 ...
                 SizedBox(
                    ...
                    CustomButton(
                      ...
                      Get.offNamed(AppRoutes.TabBarScreen);
